...
class Atri:
	...
	@property
	def Flex_13(self):
		self._getter_access_tracker["Flex_13"] = {}
		return self._Flex_13
	@Flex_13.setter
	def Flex_13(self, new_state):
		self._setter_access_tracker["Flex_13"] = {}
		global default_state
		self._Flex_13 = Flex(new_state, default_state["Flex_13"])
	...
	def Menu(self, new_state):
		...
		global default_state
		self._Menu = Menu(new_state, default_state["Menu"])
